                    ...
                    <form name="form2" id="regUser" accept-charset="utf-8" action="" method="post"> 
                        ...
                        <ul class="reg_form" id="reg-ul"> 
                            ...
                            <li> 
                                ...
                                <div class="inputOuter2"> 
                                    <input type="radio" id="radio1" name="radio" checked="checked" />男 
                                    <input type="radio" id="radio0" name="radio" />女
                                </div> 
                            </li>
                            <li> 
                                <label for="brith" class="input-tips2">出生日期：</label> 
                                <div class="inputOuter2"> 
                                    <input type="text" id="brith" name="brith" maxlength="16" class="inputstyle2" />
                                </div> 
                            </li>  
                            <li> 
